...
class SelectOpt extends StatefulWidget {
  SelectOpt({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _SelectOptState createState() => _SelectOptState();
}

class _SelectOptState extends State<SelectOpt> {
  final elements1 = [
    "Breakfast",
    "Lunch",
    "2nd Snack",
